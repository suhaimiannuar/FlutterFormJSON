    ...
    return InkWell(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
            ...
            boxShadow: <BoxShadow>[
              BoxShadow(
                  color: Color(0xff00c853).withAlpha(100),
                  offset: Offset(2, 4),
                  blurRadius: 8,
                  spreadRadius: 2)
            ],
        ...
        child: Text(
          'Login',
          style: TextStyle(fontSize: 20, color: Color(0xff00c853)),
        ),
      ),
    );
  }
  ...
  Widget _label() {
    return Container(
        ...
        child: Column(
          children: <Widget>[
            Text(
              'Quick login with NiNe Anker',
              style: TextStyle(color: Colors.white, fontSize: 17),
            ),
            SizedBox(
              height: 20,
            ),
            Icon(Icons.wifi_tethering, size: 90, color: Colors.white),
            SizedBox(
              height: 20,
            ),
            Text(
